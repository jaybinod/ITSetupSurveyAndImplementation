...
public partial class dashboard : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter cmd = new SqlDataAdapter("Select EUM.*, DM.Department from EmployeeUserMaster EUM, DepartmentMaster DM where EUM.DepartmentID=DM.DepartmentID and EUM.UserID!='" + Session["userID"]+"'", conn);
