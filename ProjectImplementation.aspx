<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterCommon.master" AutoEventWireup="true" CodeFile="ProjectImplementation.aspx.cs" Inherits="ProjectImplementation" %>
                    ...
                    <asp:TemplateField HeaderText="List of Project(s)">
                        <ItemTemplate>
                            <asp:Repeater ID="rpopen" runat="server">
                                <ItemTemplate>
                                    Click on Project Survey to Start Implementation update : [<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%#"ProjectActualUpdate.aspx?id="+Eval("ClientID", "{0}")+"&sid="+Eval("SurveyID", "{0}")%>' Text='<%#Eval("SurveyID","{0}")+" - "+ Eval("StartDate","{0:dd-MM-yyyy}")%>'></asp:HyperLink>]<br />
                                </ItemTemplate>
                            </asp:Repeater>
                            <br />
