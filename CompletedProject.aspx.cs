...
public partial class CompletedProject : System.Web.UI.Page
{
    ...
    protected void  BindDetailsView()
    {
        ...
        {
            query = "Select *, (Select EmployeeName from EmployeeUserMaster where UserID=CSM.SurveyEngineerID) SurveyEngineer, EUM.EmployeeName from ClientMaster CM, ClientServiceMaster CSM, EmployeeUserMaster EUM, SurveyClientItemHead SCIH where CM.ClientID=CSM.ClientID and CM.ClientID=SCIH.ClientID and CSM.EmployeeID=EUM.UserID and SCIH.projectstatus=1";
        }
        else
        {
            query = "Select *, (Select EmployeeName from EmployeeUserMaster where UserID=CSM.SurveyEngineerID) SurveyEngineer, EUM.EmployeeName from ClientMaster CM, ClientServiceMaster CSM, EmployeeUserMaster EUM, SurveyClientItemHead SCIH where CM.ClientID=CSM.ClientID and CM.ClientID=SCIH.ClientID and CSM.EmployeeID=EUM.UserID and CSM.EmployeeID='" + Session["userID"] + "' and SCIH.ProjectStatus=1";
        }
