<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterCommon.master" AutoEventWireup="true" CodeFile="SurveyStatus.aspx.cs" Inherits="SurveyStatus" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ItemTemplate>
                                    ...
                                    Survey Ticket ID <%#DataBinder.Eval(Container,"DataItem.SurveyID")%> - Submitted on: <%#DataBinder.Eval(Container,"DataItem.SubmittedDate","{0:dd-MMM-yyyy}")%> <asp:HyperLink ID="hlsurvey" runat="server" NavigateUrl='<%#"SurveyDetails.aspx?id="+Eval("ClientID", "{0}")+"&sid="+Eval("SurveyID", "{0}")%>' Text='View Details'></asp:HyperLink><br />
