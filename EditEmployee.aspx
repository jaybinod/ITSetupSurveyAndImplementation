<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterCommon.master" AutoEventWireup="true" CodeFile="EditEmployee.aspx.cs" Inherits="EditEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <div class="row">
    ...
    <div class="row lineheight">&nbsp;</div>
      <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-8 text-left"><asp:CheckBox ID="chkActive" Text="Active" runat="server" CssClass="form-control"></asp:CheckBox></div>
          <div class="col-md-2"></div>
    </div>
    <%--<div class="row lineheight">&nbsp;</div>
      <div class="row">
