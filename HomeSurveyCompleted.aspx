<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterCommon.master" AutoEventWireup="true" CodeFile="HomeSurveyCompleted.aspx.cs" Inherits="HomeSurveyCompleted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
        <h4>List of Completed Survey</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
